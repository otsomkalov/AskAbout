...
namespace AskAbout.Migrations
{
    ...
    [Migration("20170419123644_QuestionUserId")]
    partial class QuestionUserId
    {
            ...
            modelBuilder.Entity("AskAbout.Models.Comment", b =>
                {
                    ...
                    b.HasIndex("ReplyUserId", "ReplyQuestionId", "ReplyDate");
            ...
            modelBuilder.Entity("AskAbout.Models.Reply", b =>
                {
                    ...
                    b.HasKey("UserId", "QuestionId", "Date");
            ...
            modelBuilder.Entity("AskAbout.Models.Comment", b =>
                {
                    ...
                    b.HasOne("AskAbout.Models.Reply")
                        .WithMany("Comments")
                        .HasForeignKey("ReplyUserId", "ReplyQuestionId", "ReplyDate");
                });

            modelBuilder.Entity("AskAbout.Models.Question", b =>
                {
                    b.HasOne("AskAbout.Models.Topic")
                        .WithMany("Questions")
