    ...
    public partial class Fixes : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Replies", x => new { x.UserId, x.QuestionId, x.Date });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Comment", x => new { x.UserId, x.DateId });
                    table.UniqueConstraint("AK_Comment_DateId_UserId", x => new { x.DateId, x.UserId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        columns: x => new { x.ReplyUserId, x.ReplyQuestionId, x.ReplyDate },
